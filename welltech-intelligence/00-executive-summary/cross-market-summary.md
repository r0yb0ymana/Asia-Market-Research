...
```mermaid
timeline
    title Welltech 36-month regional roadmap — one operating system, three deployments
    Months 0-12 (Malaysia) : Launch doctor-led GLP-1 programme (RM999/mo) on WhatsApp stack : PHFSA clinic anchor + e-Rx + Alpro fulfilment : Klang Valley beachhead : Instrument first outcome cohort
    Months 6-18 (Singapore) : HCSA OMS licence + CGO (long-pole hire) : Employer metabolic beachhead vs 12-17% trend + HPB co-funding : Publish outcomes to NOVI standard : Bank credibility + capital hub
    Months 15-30 (Singapore->HK) : SG longevity membership (S$2-6k/yr) : DTC-lite + concierge overlay : Fundraise off SG credibility : HK legal verification (PHFO/UMAO/export)
    Months 24-36 (Hong Kong) : Launch dual wedge - GLP-1 (HK$3.5-5k/mo) + HNW longevity (HK$25-40k/yr) : Deploy proven stack, no new regulatory build : Insurer/employer rails (AXA/Manulife/Cigna) : GBA / mainland-shopper option
```
