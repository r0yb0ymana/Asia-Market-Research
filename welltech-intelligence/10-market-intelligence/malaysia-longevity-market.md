...
```mermaid
journey
  title Preventive-longevity member journey
  section Awareness
    Sees credible content / referral: 3: Prospect
    Compares vs hospital package / drip clinic: 2: Prospect
  section Onboarding
    WhatsApp intake + history: 4: Member
    Baseline diagnostics (ApoB, metabolic, CGM): 5: Member
    Clinician review + plan: 5: Member, Clinician
  section Engagement
    CGM + wearable tracking: 4: Member
    Coaching nudges via WhatsApp: 4: Member, Coach
    GLP-1 / lifestyle intervention: 4: Member, Clinician
  section Retention
    Quarterly re-test + progress: 5: Member, Clinician
    Biological-age / risk score trend: 4: Member
    Renewal + referral: 5: Member
```
