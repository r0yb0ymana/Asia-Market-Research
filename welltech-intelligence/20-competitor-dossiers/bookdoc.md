...
```mermaid
journey
    title BookDoc patient journey (Search & Book)
    section Discover
      Search by specialty/location: 4: Patient
      View provider profile: 4: Patient
    section Book
      Select slot, book free: 4: Patient
      Reminders pushed: 3: App
    section Attend
      Navigate (Maps/Waze) or e-hail (Grab): 3: App
      For tourists - flights/hotel/attractions links: 2: App
    section After
      No medication, follow-up or outcomes layer: 1: App
```
