...
```mermaid
journey
    title GetDoc patient journey
    section Discover
      Search clinics by location/specialty/insurance: 4: Patient
      Compare doctors, read reviews: 3: Patient
    section Book
      Book slot or teleconsult, incl. for family: 4: Patient
      Calendar + reminders: 3: App
    section Pay
      GetDocPay in-app bill payment + points: 3: Patient
      GetDocPlus member rates at panel clinics: 4: Member
    section After
      Visit log kept in app: 2: App
      No medication, care plan or outcomes layer: 1: App
```
